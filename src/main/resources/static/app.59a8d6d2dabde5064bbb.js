...
/***/ function(module, exports, __webpack_require__) {
	...
	var registration_component_1 = __webpack_require__(69);
	var login_component_1 = __webpack_require__(81);
	var angular2_materialize_1 = __webpack_require__(84);
	var hospital_service_1 = __webpack_require__(58);
	var app_routing_1 = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = (function () {
	    function AppComponent(hospitalService, router) {
	    ...
	    AppComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof hospital_service_1.HospitalService !== 'undefined' && hospital_service_1.HospitalService) === 'function' && _a) || Object, (typeof (_b = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _b) || Object])
	    ], AppComponent);
	    return AppComponent;
	    var _a, _b;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http_2 = __webpack_require__(59);
	var HospitalService = (function () {
	    function HospitalService(http) {
	        this.http = http;
	        // 192.168.1.11
	        this.hostname =  true ? '' : 'http://localhost:3000';
	        this.loginUrl = this.hostname + "/login";
	        this.citiesUrl = this.hostname + "/city?prefix=";
	        this.sourcesUrl = this.hostname + "/source?source=";
	        this.turnUrl = this.hostname + "/turnno";
	        this.departmentsUrl = this.hostname + "/department";
	        this.doctorsUrl = this.hostname + "/doctor?departmentid=";
	        this.getAuthorizedPersonUrl = this.hostname + "/autorisation";
	        this.banksUrl = this.hostname + "/bank";
	        this.registerUrl = this.hostname + "/patient/register";
	    }
	    HospitalService.prototype.registerPatient = function (registration) {
	    ...
	    HospitalService.prototype.login = function (credentials) {
	        var headers = new http_2.Headers({ 'Content-Type': 'application/json' });
	        var options = new http_2.RequestOptions({ headers: headers });
	    ...
	    HospitalService.prototype.get = function (url) {
	        return this.http.get(url)
	            .toPromise()
	            .then(function (response) { return response.json(); })
	            .catch(this.handleError);
	    };
	    HospitalService.prototype.getListOfBanks = function () {
	        return this.get(this.banksUrl);
	    };
	    HospitalService.prototype.geDiscountAuthorization = function () {
	        return this.get(this.getAuthorizedPersonUrl);
	    };
	    HospitalService.prototype.getTurnNumber = function () {
	    ...
	    HospitalService.prototype.getDepartments = function () {
	        return this.get(this.departmentsUrl);
	    };
	    HospitalService.prototype.getDoctors = function (departmentId) {
	        return this.get(this.doctorsUrl + departmentId);
	    };
	    HospitalService.prototype.getSources = function (source) {
	        return this.get(this.sourcesUrl + source);
	    };
	    HospitalService.prototype.getCities = function (prefix) {
	        return this.http.get(this.citiesUrl + prefix)
	            .map(function (response) { return response.json(); });
	    };
	    HospitalService.prototype.handleError = function (error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(3), __webpack_require__(61), __webpack_require__(4), __webpack_require__(5), __webpack_require__(55)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var router_1 = __webpack_require__(26);
	var registration_1 = __webpack_require__(71);
	var Subject_1 = __webpack_require__(4);
	__webpack_require__(72);
	var hospital_service_1 = __webpack_require__(58);
	var RegistrationComponent = (function () {
	    function RegistrationComponent(hospitalService, route) {
	        this.hospitalService = hospitalService;
	        this.route = route;
	        this.term$ = new Subject_1.Subject();
	    }
	    RegistrationComponent.prototype.getCities = function (term) {
	        var _this = this;
	    ...
	    RegistrationComponent.prototype.getSources = function ($event) {
	        var _this = this;
	    ...
	    RegistrationComponent.prototype.getDepartments = function () {
	        ...
	        this.hospitalService.getDepartments()
	            .then(function (departments) { return _this.departments = departments; });
	    };
	    RegistrationComponent.prototype.getDoctors = function (departmentId) {
	        var _this = this;
	        this.hospitalService.getDoctors(departmentId)
	            .then(function (doctors) { return _this.doctors = doctors; });
	    };
	    RegistrationComponent.prototype.getListOfBanks = function () {
	        var _this = this;
	        this.hospitalService.getListOfBanks()
	            .then(function (banks) { return _this.banks = banks; });
	    };
	    RegistrationComponent.prototype.setFees = function (doctor) {
	    ...
	    RegistrationComponent.prototype.calculateDiscount = function (total, discount) {
	        var _this = this;
	        var disc = this.registration.paymentDetails.discount = Math.floor(total * discount / 100);
	        this.registration.paymentDetails.netAmount = total - disc;
	        this.hospitalService.geDiscountAuthorization()
	            .then(function (discountDetails) { return _this.authorizedPersons = discountDetails; });
	        this.updateTextFields();
	    };
	    ...
	    RegistrationComponent.prototype.ngOnInit = function () {
	        ...
	        this.term$
	            .debounceTime(400)
	            .subscribe(function (term) { return _this.getCities(term); });
	        this.getTurnNumber();
	        this.getDepartments();
	    ...
	    RegistrationComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof hospital_service_1.HospitalService !== 'undefined' && hospital_service_1.HospitalService) === 'function' && _a) || Object, (typeof (_b = typeof router_1.ActivatedRoute !== 'undefined' && router_1.ActivatedRoute) === 'function' && _b) || Object])
...
/***/ function(module, exports) {
	...
	var ConsultantDepartment = (function () {
	    function ConsultantDepartment() {
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(26);
	var hospital_service_1 = __webpack_require__(58);
	var router_2 = __webpack_require__(26);
	var LoginComponent = (function () {
	    function LoginComponent(hospitalService, route, router) {
	        this.hospitalService = hospitalService;
	        this.route = route;
	        this.router = router;
	        this.credentials = {};
	    ...
	    LoginComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof hospital_service_1.HospitalService !== 'undefined' && hospital_service_1.HospitalService) === 'function' && _a) || Object, (typeof (_b = typeof router_1.ActivatedRoute !== 'undefined' && router_1.ActivatedRoute) === 'function' && _b) || Object, (typeof (_c = typeof router_2.Router !== 'undefined' && router_2.Router) === 'function' && _c) || Object])
	    ], LoginComponent);
...
/***/ function(module, exports) {
	...
	module.exports = "<form class=\"col s12\" materialize (ngSubmit)=\"login(credentials)\">\n    <div class=\"login-form\">\n        <h4>User Login</h4>\n        <div class=\"\">\n            <div class=\"input-field col s12\">\n                <input [(ngModel)]=\"credentials.username\" required name=\"username\"\n                    id=\"username\" type=\"text\" class=\"validate\">\n                <label for=\"username\">Username</label>\n            </div>\n        </div>\n        <div class=\"\">\n            <div class=\"input-field col s12\">\n                <input [(ngModel)]=\"credentials.password\" required name=\"password\"\n                    id=\"password\" type=\"password\" class=\"validate\">\n                <label for=\"password\">Password</label>\n            </div>\n        </div>\n        <div class=\"button-container\">\n            <button type=\"submit\" class=\"btn waves-effect\" name=\"button\">Log In</button>\n        </div>\n    </div>\n</form>\n";
...
//# sourceMappingURL=app.59a8d6d2dabde5064bbb.js.map